...
# Get API version
$GLOBALS['theme_api_v'] =
    $GLOBALS['theme_settings']['API']['version'];

# Load common API
require_all(__DIR__ . "/_api/v".$GLOBALS['theme_api_v'], 2);

# Load custom API
require_all(get_template_directory() . "/theme/api/v".$GLOBALS['theme_api_v'], 2);
...
# Stripe
include_once __DIR__ . '/_stripe/stripe.php';

# Gutenberg
include_once __DIR__ . '/_gutenberg/gutenberg.php';

# Taxonomy
include_once __DIR__ . '/_taxonomy/taxonomy.php';

# Post Type
include_once __DIR__ . '/_post-type/post-type.php';

# Shortcode
include_once __DIR__ . '/_shortcode/shortcode.php';

# Widget
include_once __DIR__. '/_widget/widget.php';

do_action('theme_init_loaded');